...
<div class="content-wrapper">
	...
	<ol class="breadcrumb">
		...
		<li class="active">Tambah Seksi Kajian</li>
	</ol>
			...
			<div class="col-md-12">
				...
				<div class="box box-primary">
					...
					<div class="box-header with-border">
						<h3 class="box-title">Tambah Data Seksi Kajian</h3>
					</div>
					<!-- /.box-header -->
					<!-- form start -->
					<form role="form" action="{{route('seksikajian.store')}}" method="POST">
						@csrf
						<div class="box-body">
							<div class="form-group">
								<label for="exampleInputEmail1">Seksi Kajian Dhuha</label>
								<input type="text" name="seksi_kajian_dhuha" class="form-control" id="exampleInputEmail1" placeholder="Nama Seksi Kajian">
							</div>
							<div class="form-group">
							...
							<div class="form-group">
								...
								<input type="text"  name="kapasitas" class="form-control" id="exampleInputText1" placeholder="Kapasitas">
							</div>
						</div>
						<!-- /.box-body -->
